...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "experiments" (
  	...
  	"laboratory_number" numeric DEFAULT 1 NOT NULL,
  ...
  ALTER TABLE "experiments" ADD CONSTRAINT "experiments_laboratory_id_laboratories_id_fk" FOREIGN KEY ("laboratory_id") REFERENCES "public"."laboratories"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "experiments_laboratory_idx" ON "experiments" USING btree ("laboratory_id");
