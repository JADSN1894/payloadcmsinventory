...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_experiments_laboratory_number" AS ENUM();
  ...
  CREATE TABLE "experiments" (
  	...
  	"laboratory_number" "enum_experiments_laboratory_number" DEFAULT 1 NOT NULL,
  ...
  ALTER TABLE "experiments" ADD CONSTRAINT "experiments_cover_image_id_media_id_fk" FOREIGN KEY ("cover_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE UNIQUE INDEX "experiments_title_idx" ON "experiments" USING btree ("title");
  CREATE UNIQUE INDEX "experiments_slug_idx" ON "experiments" USING btree ("slug");
  CREATE INDEX "experiments_cover_image_idx" ON "experiments" USING btree ("cover_image_id");
  ...
  CREATE UNIQUE INDEX "experiments_filename_idx" ON "experiments" USING btree ("filename");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_experiments_laboratory_number";`)
}
